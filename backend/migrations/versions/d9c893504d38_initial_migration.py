...
Revision ID: d9c893504d38
Revises: 
Create Date: 2025-04-07 15:26:32.179336
...
def upgrade():
    ...
    with op.batch_alter_table('faces', schema=None) as batch_op:
        ...
        batch_op.drop_index('tiger_faces_the_geom_gist', postgresql_using='gist')
    ...
    with op.batch_alter_table('addrfeat', schema=None) as batch_op:
        batch_op.drop_index('idx_addrfeat_geom_gist', postgresql_using='gist')
    ...
    with op.batch_alter_table('edges', schema=None) as batch_op:
        ...
        batch_op.drop_index('idx_tiger_edges_the_geom_gist', postgresql_using='gist')

    op.drop_table('edges')
    with op.batch_alter_table('cousub', schema=None) as batch_op:
        batch_op.drop_index('tige_cousub_the_geom_gist', postgresql_using='gist')

    op.drop_table('cousub')
    op.drop_table('pagc_lex')
    with op.batch_alter_table('place', schema=None) as batch_op:
        batch_op.drop_index('tiger_place_the_geom_gist', postgresql_using='gist')
    ...
    with op.batch_alter_table('state', schema=None) as batch_op:
        batch_op.drop_index('idx_tiger_state_the_geom_gist', postgresql_using='gist')
...
def downgrade():
    ...
    with op.batch_alter_table('county_lookup', schema=None) as batch_op:
        ...
        batch_op.create_index('county_lookup_name_idx', [sa.literal_column('soundex(name::text)')], unique=False)
    ...
    with op.batch_alter_table('state', schema=None) as batch_op:
        batch_op.create_index('idx_tiger_state_the_geom_gist', ['the_geom'], unique=False, postgresql_using='gist')
    ...
    with op.batch_alter_table('place_lookup', schema=None) as batch_op:
        ...
        batch_op.create_index('place_lookup_name_idx', [sa.literal_column('soundex(name::text)')], unique=False)
    ...
    with op.batch_alter_table('place', schema=None) as batch_op:
        batch_op.create_index('tiger_place_the_geom_gist', ['the_geom'], unique=False, postgresql_using='gist')
    ...
    with op.batch_alter_table('cousub', schema=None) as batch_op:
        batch_op.create_index('tige_cousub_the_geom_gist', ['the_geom'], unique=False, postgresql_using='gist')
    ...
    with op.batch_alter_table('edges', schema=None) as batch_op:
        batch_op.create_index('idx_tiger_edges_the_geom_gist', ['the_geom'], unique=False, postgresql_using='gist')
    ...
    with op.batch_alter_table('addrfeat', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_addrfeat_geom_gist', ['the_geom'], unique=False, postgresql_using='gist')
    ...
    with op.batch_alter_table('countysub_lookup', schema=None) as batch_op:
        ...
        batch_op.create_index('countysub_lookup_name_idx', [sa.literal_column('soundex(name::text)')], unique=False)
    ...
    with op.batch_alter_table('faces', schema=None) as batch_op:
        batch_op.create_index('tiger_faces_the_geom_gist', ['the_geom'], unique=False, postgresql_using='gist')
    ...
    with op.batch_alter_table('featnames', schema=None) as batch_op:
        ...
        batch_op.create_index('idx_tiger_featnames_snd_name', [sa.literal_column('soundex(name::text)')], unique=False)
        batch_op.create_index('idx_tiger_featnames_lname', [sa.literal_column('lower(name::text)')], unique=False)
